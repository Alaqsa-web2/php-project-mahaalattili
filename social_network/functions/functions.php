...
<textarea placeholder='write your comment here!' class='pb-cmnt-textarea' name='comment' style='resize: none; padding: 20px;
height: 110px;
width: 100%;
...
function search_user(){
	...
	<div class='col-sm-6' style='border:1px solid gray; padding:4px'>
...
<div class='col-sm-6''><a href='user_profile.php?u_id=$user_id' style='text-decoration:none; cursor:pointer; color:#3897f0'>
