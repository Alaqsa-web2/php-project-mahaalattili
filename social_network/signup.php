...
<div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="main-content" style="border-style:ridge;">
                <div class="header">
                    <h3 style="text-align: center;"><strong>Join M&E</strong></h3>
                </div>
                <div class="l-part">
                ...
                <div class="input-group">
                    ...
                    <a style="text-decoration: none;float: right;color: #187FAB;" data-toggle="tooltip" href="signin.php" title="Signin">Already have an account?</a>
